...
// Ambil kata kunci dari URL (?q=avengers)
$query = isset($_GET['q']) ? trim($_GET['q']) : '';

// Jika query tidak kosong, cari di database
$films = [];
if ($query !== '') {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    searchForm.addEventListener('submit', function (e) {
        ...
        // Tampilkan loader + disable tombol saat lagi searching
    ...
    // Optional: kalau user mulai ngetik lagi, enable tombol lagi
